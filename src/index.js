import "./style.css";
import { createHomeTab as home } from "./home.js";
import { createMenuTab as menu } from "./menu.js";
import { createContactTab as contact } from "./contact.js";
...
// initial tab
appendCards(home(svg, data.home));
...
document.querySelector("nav").addEventListener("click", (e) => {
  ...
  const handlers = { home, menu, contact };

  const cards = handlers[name](svg, data[name]);
